  ...
  return (
    <footer className="bg-brand-navy text-brand-cream border-t border-white/10 py-16" id="contact">
        <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div><h4 className="font-bold mb-4">Contact Info</h4><ul className="space-y-2 text-brand-cream/60 text-sm"><li>254 Legal Ave, Jevanjee<br/>Nairobi, NBO 00200</li><li>+254 (0) 701 234567</li><li>contact@kinyaandco.com</li></ul></div>
