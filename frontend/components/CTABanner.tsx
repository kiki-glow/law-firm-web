  ...
  return (
    <section className="py-20 bg-brand-gold text-brand-navy">
        <div className="container mx-auto px-6 md:px-12 text-center">
            ...
            <Link href={"/contact"} className="bg-brand-navy text-brand-cream px-10 py-4 rounded-full font-bold hover:bg-brand-navy/90 transition shadow-lg shadow-brand-navy/25">
                Get Started Now
            </Link>
        </div>
    </section>
